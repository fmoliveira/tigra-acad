...
namespace Tigra.Database
{
    ...
    public partial class Entities : DbContext
    {
        ...
        public virtual int SubmitRating(Nullable<long> revisionID, Nullable<int> userID, Nullable<bool> approved, string comments)
        {
            var revisionIDParameter = revisionID.HasValue ?
                new ObjectParameter("RevisionID", revisionID) :
                new ObjectParameter("RevisionID", typeof(long));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SubmitRating", revisionIDParameter, userIDParameter, approvedParameter, commentsParameter);
        }
        ...
        public virtual ObjectResult<GetBaselineList_Result> GetBaselineList(Nullable<int> cellID)
        {
            var cellIDParameter = cellID.HasValue ?
                new ObjectParameter("CellID", cellID) :
                new ObjectParameter("CellID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetBaselineList_Result>("GetBaselineList", cellIDParameter);
        }
    
        public virtual ObjectResult<GetRequirementsForBaseline_Result> GetRequirementsForBaseline(Nullable<int> cellID)
        {
            var cellIDParameter = cellID.HasValue ?
                new ObjectParameter("CellID", cellID) :
                new ObjectParameter("CellID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetRequirementsForBaseline_Result>("GetRequirementsForBaseline", cellIDParameter);
        }
    
        public virtual ObjectResult<GetExistingRequirements_Result> GetExistingRequirements(Nullable<int> cellID)
        {
            var cellIDParameter = cellID.HasValue ?
                new ObjectParameter("CellID", cellID) :
                new ObjectParameter("CellID", typeof(int));
